...
function Field:draw(x,y)
  effect = love.graphics.getShader( )
  love.graphics.setShader()
  love.graphics.draw(self.back, x-unitWorldSize/4,y-unitWorldSize/4)
  love.graphics.draw(self.mov, x-unitWorldSize/4,y-unitWorldSize/4)
...
function Field:send(x,y)
  if  self.isActive then
    return ("@field".."#"..self.fieldType.."#".."1".."#"..math.floor(x-unitWorldSize/4).."#"..math.floor(y-unitWorldSize/4))
  else
    return ("@field".."#"..self.fieldType.."#".."0".."#"..math.floor(x-unitWorldSize/4).."#"..math.floor(y-unitWorldSize/4))
  end
end