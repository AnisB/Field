...
-- Rotatifs (les deux)
MetaManRotFieldS={x=unitWorldSize*4/5,y=unitWorldSize*4/5}
-- Attractif
MetaManAttFieldS={x=unitWorldSize*8,y=unitWorldSize*4/5}
-- Repulsif
MetaManRepFieldS={x=unitWorldSize*8,y=unitWorldSize*4/5}
