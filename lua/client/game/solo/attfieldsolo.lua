...
AttFieldSolo = {}
AttFieldSolo.__index =  AttFieldSolo

function AttFieldSolo.new(type,position)
    local self = {}
    setmetatable(self, AttFieldSolo)
...
function AttFieldSolo:activate()
  self.isActive=true

end

function AttFieldSolo:disable()
  self.isActive=false
end

function AttFieldSolo:update(dt)
	self.back:update(dt);
  self.mov1:update(dt)
  self.mov2:update(dt)
  self.mov3:update(dt)
...
function AttFieldSolo:draw(x,y)
